    ...
    for _, v in pairs(Config.Items) do
        ...
        if item then
            options[#options+1] = {
                ...
                event = 'Shady-organbuyer:giveinput',
                args = {
...
RegisterNetEvent('Shady-organbuyer:giveinput', function (data)
    ...
    if input[1] ~= nil then
        if input[2] ~= nil then
            TriggerServerEvent('Shady-organbuyer:sellitem',data.item, data.price, input[1], input[2])
        else
...
Citizen.CreateThread(function()
    local resourceName = "Shady-organbuyer Started }Discord : https://discord.gg/8JdxQNRXVj  made by Shady ("..GetCurrentResourceName()..")"
    print("\n^4----------------------------------------------------------------------------------^7")
    print(resourceName)
    print("^4----------------------------------------------------------------------------------^7")
end)